...
public class Tugas3 {
   public static void main(String[] args) {
    ...
    //indexof
    System.out.println("nim 2111522018 index ke = "+nim.indexOf(2111522018));
    System.out.println("nama Yoan index ke = "+nama.indexOf("Yoan"));
    System.out.println("alamat Vianca index ke = "+alamat.indexOf("Vianca"));
